 ...
 * @author ACER
 */
public class ModificationPanier extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            panier.updateQuantite(idPanier, quantite);
            RequestDispatcher dispat = request.getRequestDispatcher("Panier");
